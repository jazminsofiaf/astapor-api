...
describe Course do
  ...
  describe 'valid?' do
    it 'should be valid' do
      analisis = ExamCourse.new(code: 7557, subject: 'Analisis',
    ...
    it 'should raise exception when course is invalid' do
      expect do
        ExamCourse.new(code: 751_57, subject: 'Analisis',
                       teacher: 'Sirne', quota: 50, modality: 'tp',
                       projector: false, laboratory: false)
    ...
    it 'should be invalid when code has less than four digits' do
      ExamCourse.new(code: 751, subject: 'Analisis',
                     teacher: 'Sirne', quota: 50, modality: 'tp',
                     projector: false, laboratory: false)
    rescue CourseError => e
      expect(e.msg).to eq('codigo_erroneo')
    ...
    it 'should not be invalid when couta is less or equal 0' do
      course = ExamCourse.new(code: 7513,
                              subject: 'Analisis',
                              teacher: 'Sirne',
                              quota: 0, modality: 'tp',
                              projector: false,
  ...
  subject(:memo) { ExamCourse.new(course_param) }
